...
exports.bookinstance_update_get = function (req, res) {
    async.parallel({
        ...
        res.render('bookinstance_form', { title: 'Update Book instance', bookinstance: results.bookinstance, selected_book: results.bookinstance.book._id, book_list: results.book_list});
    })
};
